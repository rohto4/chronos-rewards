-- ================================================
-- Chronos Rewards - Database Migration Script (Fixed)
-- Version: 1.1
-- Date: 2026-02-15
--
-- 修正内容:
-- - Realtime設定でエラーが出ないように修正
-- - 既存のテーブルに対してはIF NOT EXISTSで安全に実行
-- ================================================
...
-- ================================================
-- SECTION 7: Realtime Configuration (FIXED)
-- ================================================

-- Realtimeを有効化するテーブル
-- 既に追加されている場合はエラーにならないよう、DO文で処理
DO $$
BEGIN
  -- tasksテーブル
  IF NOT EXISTS (
